...
class CellularAutomata2D:
    ...
    def run(self,n_steps,init_state = None,n_init = None,init_size = 100,p_init = 0.5):

        if n_init is None:
            n_init = int(p_init*init_size**2)
        ...
        return Animation(states,name = self.__class__.__name__)
