...
class CellularAutomata1D:
    ...
    def show(self,states,title = "1D Cellular Automata",figsize = (8,8),cmap = "viridis",return_fig = False):
    ...
    def run_random(self,rule = None,size = 100,n_steps = 100,init_state = None,p_init = 0.1,show = True,return_fig = False,**kwargs):
        ...
        if show:
            return self.show(states,title = f"Rule {rule_str_int}: {rule_str_binary}",return_fig = return_fig,**kwargs)
        else:
            return states
